...
void TestSolutions::testEnableSharedFromThis()
{
...
void TestSolutions::removeElements()
{
    char removableStr = 'c';
...
void TestSolutions::findAllThreeElements()
{
